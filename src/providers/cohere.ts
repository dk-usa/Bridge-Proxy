...
export class CohereProvider implements Provider {
  readonly type = PROVIDER_TYPES.COHERE;
  ...
  async listModels(): Promise<ProviderModelsResponse> {
    return {
      object: 'list',
      data: [
        { id: 'command-r-plus', name: 'command-r-plus', owned_by: 'cohere' },
        { id: 'command-r', name: 'command-r', owned_by: 'cohere' },
        { id: 'command', name: 'command', owned_by: 'cohere' },
        { id: 'command-nightly', name: 'command-nightly', owned_by: 'cohere' },
        { id: 'c4ai-Command-R-v01', name: 'c4ai-Command-R-v01', owned_by: 'cohere' },
      ],
    };
  }
