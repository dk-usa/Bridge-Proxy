...
export function loadConfig(env: Record<string, string | undefined> = process.env): Config {
  ...
  // If there's already a promise, return the config after it resolves
  if (configPromise) {
    return configPromise as unknown as Config;
  }
  ...
  // For synchronous access, we need to wait for the promise
  // This is a simplified approach - in practice, you'd await loadConfig at startup
  return configPromise as unknown as Config;
}
